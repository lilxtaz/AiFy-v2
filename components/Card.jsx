...
const Card = (props) => {
  ...
  return (
    <div className=' bg-back-smoke flex lg:flex-row sm:flex-col justify-between px-[10%] py-[10%] rounded-lg hover:scale-110 transition-all duration-150 w-[100%] sm:mb-2 lg:mb-0' style={{ boxShadow: '0 5px 10px 0 rgb(10 10 10 / 5%)', borderColor: 'transparent'}}>
