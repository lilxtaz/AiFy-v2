  ...
  return (
    <div className={`flex px-[10vw] md:py-[12vh] md:pb-[30vh] sm:pb-[30vh] sm:py-[0vh]`}>
        <div className={`flex flex-col z-10`}>
          <h1 className={`lg:${styles.heroHeading} head sm:pb-[0vh] lg:w-3/6`} >AiFy <br /> ultimate AI writing assistant.</h1>
          <div className=' absolute lg:bottom-[14%] md:bottom-[4%] md:left-[10%] sm:bottom-[10%]'>
