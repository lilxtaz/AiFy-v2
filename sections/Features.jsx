  ...
  return (
    <div className={`${styles.xPaddings} flex mt-44 px-[10vw] flex-col items-center justify-center text-center`}>
        <div className='flex lg:flex-row sm:flex-col items-center justify-center '>
            ...
            <img src="/chatgpt-icon.svg" className='w-[128px] px-7 sm:my-4 lg:my-0'/>
        ...
        <div className='flex flex-row items-center sm:hidden lg:flex justify-between my-52'>
            <div >
                ...
                priority={true}
                src="/iphone.png" style={{transform:'scale(2.2)'}} 
            ...
            <div className=' grid grid-rows-3 grid-cols-1 gap-x-10 gap-y-5  lg:pl-[20%] md:pl-0 sm:pl-0'>
                ...
                >
                <Card title="Voice Control" content="I also have a voice and can serve as your assistant to help you explore easily." icon={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#998da0" className="w-6 h-6 hover:bounceOrig transition-all duration-1000">
                    <path d="M8.25 4.5a3.75 3.75 0 117.5 0v8.25a3.75 3.75 0 11-7.5 0V4.5z" />
                    <path d="M6 10.5a.75.75 0 01.75.75v1.5a5.25 5.25 0 1010.5 0v-1.5a.75.75 0 011.5 0v1.5a6.751 6.751 0 01-6 6.709v2.291h3a.75.75 0 010 1.5h-7.5a.75.75 0 010-1.5h3v-2.291a6.751 6.751 0 01-6-6.709v-1.5A.75.75 0 016 10.5z" />
                    </svg>
                }/>
